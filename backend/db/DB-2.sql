...
CREATE TABLE staff (
    ...
    role_id INTEGER REFERENCES roles(id) ON DELETE SET NULL,  -- moved here    
...
-- Add FK from department.head_id to staff.id now that staff exists
ALTER TABLE departments
    ADD CONSTRAINT fk_department_head FOREIGN KEY (head_id)
    REFERENCES staff(id) ON DELETE SET NULL;

-- ==========================================================
-- MODULES (System functional areas)
-- ==========================================================
...
-- ==========================================================
-- ROLE PERMISSIONS (CRUD by module)
-- ==========================================================
...
-- ==========================================================
-- SYSTEM USERS (Login credentials only)
-- ==========================================================
...
CREATE TABLE visit_services (
    ...
    performed_by_doctor_id INTEGER REFERENCES staff(id) ON DELETE SET NULL,
    notes TEXT,
    created_by INTEGER NOT NULL REFERENCES system_users(id),
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMPTZ,
...
CREATE TABLE patient_diagnoses (
    ...
    diagnosing_doctor_id INTEGER NOT NULL REFERENCES staff(id) ON DELETE CASCADE,
...
CREATE TABLE prescriptions (
    ...
    prescribing_doctor_id INTEGER NOT NULL REFERENCES staff(id) ON DELETE CASCADE,
...
CREATE TABLE lab_orders (
    ...
    ordering_doctor_id INTEGER NOT NULL REFERENCES staff(id) ON DELETE CASCADE,
...
CREATE TABLE vaccination_schedules (
    ...
    administering_doctor_id INTEGER REFERENCES staff(id) ON DELETE SET NULL,
...
CREATE TABLE expenses (
    ...
    bank_name VARCHAR(100),
    check_number VARCHAR(50),
    recorded_by_doctor_id INTEGER REFERENCES staff(id) ON DELETE SET NULL,
    created_by INTEGER NOT NULL REFERENCES system_users(id),
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMPTZ,
    deleted_by INTEGER REFERENCES system_users(id)
...
CREATE TABLE medical_certificates (
    ...
    patient_id INTEGER NOT NULL REFERENCES patients(id) ON DELETE CASCADE,
    issuing_doctor_id INTEGER NOT NULL REFERENCES staff(id) ON DELETE CASCADE,
